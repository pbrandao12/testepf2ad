...
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/Carlosanalista/pf2ad-2.4.4/master/samba.inc
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/Carlosanalista/pf2ad-2.4.4/master/samba.xml
...
cd /usr/local/pkg
fetch -o - -q https://raw.githubusercontent.com/Carlosanalista/pf2ad-2.4.4/master/squid_winbind_auth.patch | patch -b -p0 -f
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/Carlosanalista/pf2ad-2.4.4/master/squid.inc
